...
function Player1:onEnterFrame(e)
	...
	if self.isleft and not self.isright then self.body:applyTorque(0, -force*16, 0)
	elseif self.isright and not self.isleft then self.body:applyTorque(0, force*16, 0)
	end
end
