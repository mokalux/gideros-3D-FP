...
--[[
	...
	Lighting.setLight(px-3, py+8, pz-6, 0.3) -- hgy29
--	Lighting.setLightTarget(px+2, py-0, pz, 24, 45) -- hgy29
	Lighting.setLightTarget(px+3, py-0, pz, 64*2, 100) -- hgy29
]]
	-- player listeners
...
function LevelX:onEnterFrame(e)
	...
	self.camera:lookAt(
		...
		self.tiled_level.player1:getX() + 0, self.tiled_level.player1:getY() + 2.5, self.tiled_level.player1:getZ() + 0, -- + 2
		0, 1, 0
	)
	-- lighting
	local px, py, pz = matrix:transformPoint(0, 0, 0) -- hgy29
...
--	Lighting.setLightTarget(px, py, pz, 20, 45) -- hgy29
	Lighting.setLight(px-8, py+12, pz-2, 0.4) -- hgy29
	Lighting.setLightTarget(px, py, pz, 24, 45) -- hgy29
	--Compute shadows
